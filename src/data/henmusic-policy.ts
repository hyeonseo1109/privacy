...
export const henMusicPrivacyPolicy = {
  ...
  summary:
    "HenMusic은 기기의 로컬 음악을 재생하고 사용자가 선택한 앨범 커버와 가사를 기기 안에서 관리합니다. 음원 파일, 음악 정보, 가사 또는 사용 기록을 개발자나 제3자 서버로 전송하지 않습니다.",
  sections: [
    {
      id: "overview",
    ...
    },
    {
      ...
      paragraphs: [
        "앱은 인터넷 권한을 요청하지 않으며 원격 앨범커버 검색, 원격 가사 검색, 광고, 사용자 행동 분석, 로그인 또는 크래시 수집 서비스를 사용하지 않습니다.",
